...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.php">Stock Prediction</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" id="INFOSYS"  href="INFOSYS.php">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      -->
        ...
        <nav>
          <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <a class="nav-item nav-link active" id="nav-new-tab" data-toggle="tab" href="#nav-news" role="tab" aria-controls="nav-home" aria-selected="true">News Analysis</a>
            <a class="nav-item nav-link" id="nav-history-tab" data-toggle="tab" href="#nav-history" role="tab" aria-controls="nav-profile" aria-selected="false">Historical data Analysis</a>
        ...
        <div class="tab-content" id="nav-tabContent">
          ...
          <div class="tab-pane fade" id="nav-history" role="tabpanel" aria-labelledby="nav-profile-tab">
                  ...
                  <div class="container " >
                    <img width="100%" height="375px"  alt="accuracy" />
                </div>
          ...
          <div class="tab-pane fade" id="nav-twitter" role="tabpanel" aria-labelledby="nav-contact-tab">
                  ...
                  <div class="container">
                  <img src="img/tesla_tweet.png" alt="Hist_info_lstm_pic" />
                </div>
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i>History</div>
        <div class="card-body">
